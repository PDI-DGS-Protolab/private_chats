...
IronLocation = {};                                                                                              // 41
                                                                                                                // 42
IronLocation.options = {                                                                                        // 43
  "linkSelector": 'a[href]'                                                                                     // 44
};                                                                                                              // 45
                                                                                                                // 46
IronLocation.configure = function(options){                                                                     // 47
  if (this.isStarted){                                                                                          // 48
    IronLocation.unbindEvents();                                                                                // 49
  }                                                                                                             // 50
  _.extend(this.options, options);                                                                              // 51
                                                                                                                // 52
  if(this.isStarted){                                                                                           // 53
    IronLocation.bindEvents();                                                                                  // 54
  }                                                                                                             // 55
};                                                                                                              // 56
                                                                                                                // 57
IronLocation.origin = function () {                                                                             // 58
  return location.protocol + '//' + location.host;                                                              // 59
};                                                                                                              // 60
                                                                                                                // 61
IronLocation.isSameOrigin = function (href) {                                                                   // 62
  var origin = IronLocation.origin();                                                                           // 63
  return href.indexOf(origin) === 0;                                                                            // 64
};                                                                                                              // 65
                                                                                                                // 66
IronLocation.get = function () {                                                                                // 67
  dep.depend();                                                                                                 // 68
  return location;                                                                                              // 69
};                                                                                                              // 70
                                                                                                                // 71
IronLocation.path = function () {                                                                               // 72
  dep.depend();                                                                                                 // 73
  return location.pathname + location.search + location.hash;                                                   // 74
};                                                                                                              // 75
                                                                                                                // 76
IronLocation.set = function (url, options) {                                                                    // 77
  options = options || {};                                                                                      // 78
                                                                                                                // 79
  var state = options.state || {};                                                                              // 80
                                                                                                                // 81
  if (/^http/.test(url))                                                                                        // 82
    href = url;                                                                                                 // 83
  else {                                                                                                        // 84
    if (url.charAt(0) !== '/')                                                                                  // 85
      url = '/' + url;                                                                                          // 86
    href = IronLocation.origin() + url;                                                                         // 87
  }                                                                                                             // 88
                                                                                                                // 89
  if (!IronLocation.isSameOrigin(href))                                                                         // 90
    window.location = href;                                                                                     // 91
  else if (options.where === 'server')                                                                          // 92
    window.location = href;                                                                                     // 93
  else if (options.replaceState)                                                                                // 94
    IronLocation.replaceState(state, options.title, url);                                                       // 95
  else                                                                                                          // 96
    IronLocation.pushState(state, options.title, url);                                                          // 97
                                                                                                                // 98
  if (options.skipReactive !== true)                                                                            // 99
    dep.changed();                                                                                              // 100
};                                                                                                              // 101
                                                                                                                // 102
IronLocation.pushState = function (state, title, url) {                                                         // 103
  popped = true;                                                                                                // 104
  if (history.pushState)                                                                                        // 105
    history.pushState(state, title, url);                                                                       // 106
  else                                                                                                          // 107
    window.location = url;                                                                                      // 108
};                                                                                                              // 109
                                                                                                                // 110
IronLocation.replaceState = function (state, title, url) {                                                      // 111
  popped = true;                                                                                                // 112
  if (history.replaceState)                                                                                     // 113
    history.replaceState(state, title, url);                                                                    // 114
  else                                                                                                          // 115
    window.location = url;                                                                                      // 116
};                                                                                                              // 117
                                                                                                                // 118
IronLocation.bindEvents = function(){                                                                           // 119
  $(window).on('popstate', onpopstate);                                                                         // 120
  $(document).on('click', this.options.linkSelector, onclick);                                                  // 121
};                                                                                                              // 122
                                                                                                                // 123
IronLocation.unbindEvents = function(){                                                                         // 124
  $(window).off('popstate', onpopstate);                                                                        // 125
  $(window).off('click', this.options.linkSelector, onclick);                                                   // 126
};                                                                                                              // 127
                                                                                                                // 128
IronLocation.start = function () {                                                                              // 129
  if (this.isStarted)                                                                                           // 130
    return;                                                                                                     // 131
                                                                                                                // 132
  IronLocation.bindEvents();                                                                                    // 133
  this.isStarted = true;                                                                                        // 134
                                                                                                                // 135
  // store the fact that this is the first route we hit.                                                        // 136
  // this serves two purposes                                                                                   // 137
  //   1. We can tell when we've reached an unhandled route and need to show a                                  // 138
  //      404 (rather than bailing out to let the server handle it)                                             // 139
  //   2. Users can look at the state to tell if the history.back() will stay                                   // 140
  //      inside the app (this is important for mobile apps).                                                   // 141
  if (history.replaceState)                                                                                     // 142
    history.replaceState({initial: true}, null, location.pathname + location.search + location.hash);           // 143
};                                                                                                              // 144
                                                                                                                // 145
IronLocation.stop = function () {                                                                               // 146
  IronLocation.unbindEvents();                                                                                  // 147
  this.isStarted = false;                                                                                       // 148
};                                                                                                              // 149
                                                                                                                // 150
IronLocation.start();                                                                                           // 151
                                                                                                                // 152
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//# sourceMappingURL=daf52f0e711d2c89a6209039952d64e6125923b9.map
